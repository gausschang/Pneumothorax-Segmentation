...
cls_weights = [f'../../step2_ntuh_training/ntuh_classification/model_weights/fold_{i}_eff_cls_ntuh/fold_{i}_eff_cls_ntuh_' for i in range(5)]
seg_weights = [f'../../step2_ntuh_training/ntuh_segmentation/model_weights/fold_{i}_eff_seg_ntuh/fold_{i}_eff_seg_ntuh_' for i in range(5)]

seg_config = {'encoder_name':'tu-tf_efficientnetv2_s_in21ft1k', 'method': 'Unet', 'classes':2, 'weight_list':seg_weights}
