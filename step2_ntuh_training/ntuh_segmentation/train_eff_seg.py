...
def train(max_epoch = 100, fold_num=0, pt_path=''):

    project_name = f'fold_{fold_num}_eff_seg_ntuh'
    ...
    model = getattr(smp, 'Unet')(
        encoder_name='tu-tf_efficientnetv2_s_in21ft1k',        # choose encoder, e.g. mobilenet_v2 or efficientnet-b7
    ...
    for epoch in range(max_epoch):
        ...
        if True:
            ...
            with torch.no_grad():
                ...
                writer.add_scalars('Val_Dice', {'ntu':siim}, epoch)
